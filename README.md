...
Mannan's personal portfolio site: Next.js 15 (App Router), React 19, TypeScript, and Tailwind CSS 4. The repo also holds three attached Cloudflare Worker services (`cloud-worker/`, `mcp-worker/`, `visits-worker/`) that support the site.

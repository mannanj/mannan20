    ...
    <div>
      <div className="my-5 relative flex flex-col items-center">
        <div className="absolute left-1/2 -translate-x-1/2 w-screen h-[200px] overflow-hidden">
          ...
          <h1 className="absolute top-0 left-0 right-0 z-10 uppercase text-[3em] [text-shadow:0_0_10px_rgba(0,0,0,0.8)] m-0 leading-[1.2] text-white text-center pt-6">
            Mannan
          </h1>
        </div>
        <div className="mt-[125px] relative z-10 rounded-full border-[3px] border-[#0b0b0b]">

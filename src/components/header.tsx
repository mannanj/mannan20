      ...
      >
        ...
        >
          ...
          <div className={`absolute inset-0 pointer-events-none transition-opacity duration-300 ${gardenExpanded ? 'opacity-100' : 'opacity-0'}`}>
            <div className="absolute left-[1px] -top-[30px] w-[34px] h-[35px] opacity-[0.08]" style={{ background: 'linear-gradient(to bottom, transparent 0%, #e8d44d 30%, #e8d44d 70%, transparent 100%)', clipPath: 'polygon(35% 0%, 65% 0%, 100% 100%, 0% 100%)' }} />

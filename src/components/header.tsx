...
export function Header() {
  ...
  const stage1LeafScale = showLeaves
    ? 1 +
      2.5 *
        Math.min(
          (gardenRootScale - LEAF_THRESHOLD) /
            (LEAF_CAP_THRESHOLD - LEAF_THRESHOLD),
          1,
        )
    : 1;
  const stage1LeafOpacity = Math.min(
    (gardenRootScale - LEAF_THRESHOLD) * 2.5,
    0.85,
  );
  ...
  const stage2LeafOpacity = showBranches
    ...
    : 0;
  const stage2LeafScale =
    gardenRootScale >= BRANCH_LEAF_GROW_THRESHOLD
      ? 1 +
        2.0 * Math.min((gardenRootScale - BRANCH_LEAF_GROW_THRESHOLD) / 1.3, 1)
      : 1;
  ...
  const stage3LeafOpacity = showStage3
    ...
    : 0;
  const stage3LeafScale =
    gardenRootScale >= STAGE3_THRESHOLD + 1.5
  ...
  const stage4BranchProgress = showStage4
    ? Math.min(
        (gardenRootScale - STAGE4_THRESHOLD) /
          (STAGE4_FLOWER_END - STAGE4_THRESHOLD),
        1,
      )
    : 0;
  ...
  const stage4IridescentScale = showStage4
    ? Math.min(
        (gardenRootScale - STAGE4_THRESHOLD) /
          (STAGE4_IRIDESCENT_END - STAGE4_THRESHOLD),
        1,
      )
    : 0;
  ...
  const phase2Slots = useMemo(() => {
    ...
    for (let i = 0; i < count + extraLeaves; i++) {
      ...
      const tipX =
        side === "left" ? 0.5 + Math.random() * 3 : 17 + Math.random() * 3.5;
      const type =
        i >= count
          ? "leaf"
          : Math.random() < 0.5
      ...
      const midX =
        side === "left" ? 10 - (10 - tipX) * 0.5 : 10 + (tipX - 10) * 0.5;
    ...
    for (let b = 0; b < batches; b++) {
      ...
      for (let i = 0; i < count + extraLeaves; i++) {
        ...
        slots.push({
          ...
          type,
          rotation,
          sizeScale: 0.65 + Math.random() * 0.25,
          key: key++,
          show: Math.random() < 0.85,
          branchStartY,
          midX,
    ...
    >
      ...
      >
        ...
        >
          ...
          />
          <div
            className={`absolute inset-0 pointer-events-none transition-opacity duration-300 ${gardenExpanded ? "opacity-0" : "opacity-100"}`}
          >
            <div
          ...
          <div
            className={`absolute inset-0 pointer-events-none transition-opacity duration-300 ${gardenExpanded ? "opacity-100" : "opacity-0"}`}
          >
            <div
              className="absolute left-[5px] -top-[25px] w-[26px] h-[30px] transition-opacity duration-500"
              style={{
          ...
          <div
            ...
            style={{
              ...
              width: "60px",
              height: `${55 * Math.max(gardenRootScale, 0.2)}px`,
              marginLeft: "0px",
            }}
            onMouseEnter={() => {
              rootHoveredRef.current = true;
              setRootHovered(true);
              openGarden();
            }}
            onMouseLeave={() => {
              rootHoveredRef.current = false;
              setRootHovered(false);
              closeGarden();
            }}
            onMouseMove={(e) =>
              setRootCursorPos({ x: e.clientX, y: e.clientY })
            }
          >
            <svg
              viewBox="0 0 20 55"
            ...
            >
              ...
              {showLeaves && (
                <>
                  <g
                    transform={`translate(4, 13) scale(1, ${1 / gardenRootScale}) translate(-4, -13)`}
                  >
                    <ellipse
                      cx={4}
                      cy={13}
                  ...
                  <g
                    transform={`translate(17, 25) scale(1, ${1 / gardenRootScale}) translate(-17, -25)`}
                  >
                    <ellipse
                      cx={17}
                      cy={25}
                  ...
                  <g
                    transform={`translate(4, 38) scale(1, ${1 / gardenRootScale}) translate(-4, -38)`}
                  >
                    <ellipse
                      cx={4}
                      cy={38}
                  ...
                  <g
                    transform={`translate(16, 49) scale(1, ${1 / gardenRootScale}) translate(-16, -49)`}
                  >
                    <ellipse
                      cx={16}
                      cy={49}
              ...
              {showBranches && (
                <>
                  <path
                    ...
                    pathLength={1}
                    strokeDasharray={1}
                    strokeDashoffset={Math.max(1 - stage2BranchProgress, 0)}
                  />
                  <path
                  ...
                  {stage2LeafOpacity > 0 && (
                    <>
                      <g
                        transform={`translate(18, 18.5) scale(1, ${1 / gardenRootScale}) translate(-18, -18.5)`}
                      >
                        <ellipse
                          cx={18}
                          cy={18.5}
                      ...
                      <g
                        transform={`translate(2, 30.5) scale(1, ${1 / gardenRootScale}) translate(-2, -30.5)`}
                      >
                        <ellipse
                          cx={2}
                          cy={30.5}
                      ...
                      <g
                        transform={`translate(19, 43.5) scale(1, ${1 / gardenRootScale}) translate(-19, -43.5)`}
                      >
                        <ellipse
                          cx={19}
                          cy={43.5}
                      ...
                      <g
                        transform={`translate(1, 54) scale(1, ${1 / gardenRootScale}) translate(-1, -54)`}
                      >
                        <ellipse
                          cx={1}
                          cy={54}
              ...
              {showStage3 && (
                <>
                  <path
                    ...
                    pathLength={1}
                    strokeDasharray={1}
                    strokeDashoffset={Math.max(1 - stage3BranchProgress, 0)}
                  />
                  <path
                  ...
                  {stage3LeafOpacity > 0 && (
                    <>
                      <g
                        transform={`translate(3, 8) scale(1, ${1 / gardenRootScale}) translate(-3, -8)`}
                      >
                        <ellipse
                          cx={3}
                          cy={8}
                      ...
                      <g
                        transform={`translate(18, 20.5) scale(1, ${1 / gardenRootScale}) translate(-18, -20.5)`}
                      >
                        <ellipse
                          cx={18}
                          cy={20.5}
                      ...
                      <g
                        transform={`translate(2, 33.5) scale(1, ${1 / gardenRootScale}) translate(-2, -33.5)`}
                      >
                        <ellipse
                          cx={2}
                          cy={33.5}
                      ...
                      <g
                        transform={`translate(19, 39.5) scale(1, ${1 / gardenRootScale}) translate(-19, -39.5)`}
                      >
                        <ellipse
                          cx={19}
                          cy={39.5}
                      ...
                      <g
                        transform={`translate(2.5, 49.5) scale(1, ${1 / gardenRootScale}) translate(-2.5, -49.5)`}
                      >
                        <ellipse
                          cx={2.5}
                          cy={49.5}
              ...
              {showStage4 && (
                <>
                  <path
                    ...
                    pathLength={1}
                    strokeDasharray={1}
                    strokeDashoffset={Math.max(1 - stage4BranchProgress, 0)}
                  />
                  <path
                  ...
                  {flowerSlots.map((slot) => {
                    ...
                    const scale =
                      slot.type === "white"
                        ? stage4FlowerScale
                        : stage4IridescentScale;
                    if (scale <= 0) return null;
                    const cx = slot.x;
                    const cy = slot.y;
                    const s =
                      scale *
                      (slot.type === "white" ? 2 : 2.25) *
                      slot.sizeScale;
                    ...
                    if (slot.type === "white") {
                      return (
                        <g
                          key={slot.key}
                          transform={`translate(${cx}, ${cy}) scale(1, ${1 / gardenRootScale}) translate(${-cx}, ${-cy})`}
                        >
                          <g
                            transform={`translate(${cx}, ${cy}) scale(${s}) rotate(${r}) translate(${-cx}, ${-cy})`}
                          >
                            <ellipse
                              cx={cx}
                              cy={cy - 4.5}
                ...
                <>
                  {phase2Slots.map((slot) => {
                    ...
                    const bProg = Math.min(
                      phase2BranchProgress * (0.7 + slot.key * 0.03),
                      1,
                    );
                  ...
                  {phase2Slots
                    ...
                    .map((slot) => {
                      ...
                      return (
                        <g
                          key={`p2-leaf-${slot.key}`}
                          transform={`translate(${slot.x}, ${slot.y}) scale(1, ${1 / gardenRootScale}) translate(${-slot.x}, ${-slot.y})`}
                        >
                          <g
                            transform={`translate(${slot.x}, ${slot.y}) scale(${ls}) rotate(${slot.rotation}) translate(${-slot.x}, ${-slot.y})`}
                          >
                            <ellipse
                              cx={slot.x}
                              cy={slot.y - 2}
                  ...
                  {phase2Slots
                    ...
                    .map((slot) => {
                      const scale =
                        slot.type === "iridescent"
                          ? phase2IridescentScale
                          : phase2DecorScale;
                      if (scale <= 0) return null;
                      const cx = slot.x;
                      const cy = slot.y;
              ...
              {showPhase2Decor2 && (
                <>
                  {phase2Slots2.map((slot) => {
                    if (!slot.show) return null;
                    const bProg = Math.min(
                      phase2Decor2BranchProgress * (0.7 + slot.key * 0.03),
                      1,
                    );
                    const mainX = 10 + (slot.side === "left" ? -1 : 1) * 0.5;
                    return (
              ...
              {phase3Slots.map((slot) => {
                if (!slot.show || gardenRootScale < slot.batchThreshold)
                  return null;
                const elapsed = gardenRootScale - slot.batchThreshold;
                const bProg = Math.min(
                  elapsed * 0.12 * (0.7 + (slot.key % 3) * 0.1),
                  1,
                );
                const mainX = 10 + (slot.side === "left" ? -1 : 1) * 0.5;
                const dScale =
                ...
                return (
                  <g key={`p3-${slot.key}`}>
                    ...
                    {dScale > 0 && slot.type === "leaf" && (
                      ...
                      >
                        <g
                          transform={`translate(${cx}, ${cy}) scale(${dScale * 2.4 * slot.sizeScale}) rotate(${r}) translate(${-cx}, ${-cy})`}
                        >
                          <ellipse
                            cx={cx}
                            cy={cy - 2}
              ...
              {phase3Slots.map((slot) => {
                if (
                  !slot.show ||
                  gardenRootScale < slot.batchThreshold ||
                  slot.type === "leaf"
                )
                  return null;
                const elapsed = gardenRootScale - slot.batchThreshold;
                ...
                const r = slot.rotation;
                const s =
                  dScale * (slot.type === "white" ? 2 : 2.25) * slot.sizeScale;
                if (slot.type === "white") {
                  return (
                    <g
                      key={`p3-fl-${slot.key}`}
          ...
          >
            ...
            <polygon
              points="5.8,14.5 6.7,17.8 9.3,17.8 10.2,14.5"
              fill="#5a3a1a"
            />
          </svg>
          <svg
          ...
          >
            ...
            <polygon
              points="6.3,14.5 7.2,17.3 8.8,17.3 9.7,14.5"
              fill="#5a3a1a"
            />
          </svg>
          <div

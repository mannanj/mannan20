...
@Component({
  ...
  styles: [`
    ...
    .viewer-fadeIn {
      animation: viewer-fadeIn 1000ms cubic-bezier(0.4, 0, 0.2, 1) forwards;
    }
  `],
  template: `
      <div animate.enter="viewer-fadeIn" class="fixed bottom-1 left-2 z-50 px-3 py-1.5 rounded backdrop-blur-md bg-black/70 opacity-80 hover:opacity-100 transition-opacity duration-200 cursor-pointer"
           (click)="openCommands()">

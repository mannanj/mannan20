  ...
  protected colDefs: ColDef[] = [
    ...
    },
    {
      ...
      cellRenderer: (params: ICellRendererParams) => {
        ...
        if (status === 'completed') {
          return `<span style="padding: 2px; border-radius: 3px; font-size: 8px; text-transform: uppercase; background: #1a4d2e; color: #4ade80; font-weight: 600; display: inline-block; text-shadow: -1px -1px 0 #fff, 1px -1px 0 #fff, -1px 1px 0 #fff, 1px 1px 0 #fff;">COMPLETED</span>`;
        }

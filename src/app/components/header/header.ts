...
import { CursorStatus } from '../cursor-status/cursor-status';

@Component({
  selector: 'header',
  imports: [CommonModule, CursorStatus],
  template: `
    <div class="flex justify-between items-center fixed top-0 w-screen bg-[#0b0b0b] border-b border-white h-[66px] z-[99] px-4">
